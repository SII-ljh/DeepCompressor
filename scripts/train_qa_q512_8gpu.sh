#!/bin/bash
# Training script for Q=512 with 8 GPUs (Compression ratio 8:1, early stopping)

set -e  # Exit on error

echo "========================================================================"
echo "Deep Compressor QA Training - Q=512 (Compression 8:1, 8 GPUs, early stopping)"
echo "========================================================================"
