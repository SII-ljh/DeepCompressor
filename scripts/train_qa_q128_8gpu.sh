#!/bin/bash
# Training script for Q=128 with 8 GPUs (Compression ratio 32:1, 3 epochs)

set -e  # Exit on error

echo "========================================================================"
echo "Deep Compressor QA Training - Q=128 (Compression 32:1, 8 GPUs, 3 epochs)"
echo "========================================================================"
...
# steps/epoch = 484K / 480 ≈ 1008, 3 epochs = 3024
MAX_STEPS=3024
WARMUP_STEPS=151
LEARNING_RATE=1e-4
EVAL_EVERY=252
