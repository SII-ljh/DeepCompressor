#!/bin/bash
# Training script for Q=128 with 8 GPUs
# Full-scale QA training on large dataset (~800K samples)

set -e  # Exit on error

echo "========================================================================"
echo "Deep Compressor QA Training - Q=128 (8 GPUs)"
echo "========================================================================"
...
WANDB_RUN_NAME="qa_q128_8gpu_full"
...
BATCH_SIZE=6           # Per GPU batch size (slightly smaller due to larger Q)
GRAD_ACCUM=3           # Gradient accumulation steps
# Effective batch size = 8 GPUs × 6 batch × 3 accum = 144
MAX_STEPS=50000
WARMUP_STEPS=2000
LEARNING_RATE=1e-4
EVAL_EVERY=1000
