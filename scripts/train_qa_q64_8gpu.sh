#!/bin/bash
# Training script for Q=64 with 8 GPUs
# Full-scale QA training on large dataset (~800K samples)

set -e  # Exit on error

echo "========================================================================"
echo "Deep Compressor QA Training - Q=64 (8 GPUs)"
echo "========================================================================"
...
WANDB_RUN_NAME="qa_q64_8gpu_full"
...
# Effective batch size = 8 GPUs × 32 batch × 2 accum = 512
MAX_STEPS=50000
WARMUP_STEPS=2000
LEARNING_RATE=1e-4
EVAL_EVERY=1000
